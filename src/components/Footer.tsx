      ...
      <div className="container">
        <div className="row text-white">
          ...
          <div className="col-12 col-md-4 mb-4 mb-md-0">
            ...
            <ul className="list-unstyled">
              <li>
                <a href="nosotros.html" className="footer-link">Quiénes somos</a>
              </li>
            </ul>
          </div>
          ...
          <div className="col-12 col-md-4">
            ...
            <ul className="list-unstyled">
              <li>
                <a href="comunidad.html" className="footer-link">Comunidad</a>
              </li>
              <li>
                <a href="comunidad.html" className="footer-link">Redes Sociales</a>
              </li>
            </ul>
          </div>
        </div>
